...
Categorias:
- de **saúde**, para monitorar aspectos importantes do negócio, serviço, produto ou engajamento de pessoas em um contorno. É possível ter delimitador inferior e superior que indiquem o intervalo de saúde. Um exemplo de modelo para indicador de métricas, sem delimitadores, relacionadas a engajamento de pessoas com um produto ou serviço:
