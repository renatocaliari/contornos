...
A [hierarquia](outlines#escopo) de escopos utilizada para identificação de um contorno de forma única foi inspirada em [namespace](https://pt.wikipedia.org/wiki/Espa%C3%A7o_de_nomes), conceito utilizado em várias linguagens de programação.
